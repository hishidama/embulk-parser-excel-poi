...
import org.embulk.parser.poi_excel.util.SearchMergedCell;
...
public class PoiExcelColumnBean {
    ...
    public PoiExcelColumnBean(PoiExcelSheetBean sheetBean, Column column, ColumnOptionTask mainTask, ColumnOptionTask optionTask) {
